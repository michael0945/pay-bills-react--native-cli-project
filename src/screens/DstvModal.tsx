...
type ModalProps = {
    visible: boolean;
    onClose: () => void;
    type: 'loading' | 'success' | 'error' | 'calculation';
    data?: {
        amount?: string;
...
const DstvModal: React.FC<ModalProps> = ({
    visible,
    onClose,
    type,
    data,
            ...
            case 'error':
                return (
                    <View style={styles.modalContainer}>
                        ...
                        <Text style={styles.modalSubText}>{data?.error}</Text>
                    </View>
                );
            ...
            case 'success':
                return (
                    <View style={styles.modalSuccessContainer}>
                        ...
                        <Text style={styles.successMessageText}>Payment Successful</Text>
                        <Text style={styles.refText}>Ref # {data?.referenceNumber}</Text>

                        <View style={styles.buttonRow}>
                            <TouchableOpacity style={styles.newPaymentButton} onPress={onNewPayment}>
                        ...
                        <TouchableOpacity style={styles.printButton} onPress={onClose}>
                ...
                return (
                    <View style={styles.calculationContainer}>
                        ...
                        <View style={styles.row}>
                            ...
                            <Text style={styles.value}>{data?.accountNumber || 'N/A'}</Text>
                        </View>
                        {/* ... other calculation rows ... */}
